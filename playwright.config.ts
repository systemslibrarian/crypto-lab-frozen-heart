...
export default defineConfig({
  ...
  reporter: 'list',
  use: {
    baseURL: 'http://localhost:4641/crypto-lab-frozen-heart/',
    colorScheme: 'dark',
  },
  webServer: {
    ...
    command: 'npm run build && npm run preview -- --port 4641 --strictPort',
    url: 'http://localhost:4641/crypto-lab-frozen-heart/',
